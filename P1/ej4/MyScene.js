...
class MyScene extends THREE.Scene {
	constructor(myCanvas) {
		...
		this.trebol.position.set(this.trebol.position.x + this.objPos[0].x,
			this.trebol.position.y + this.objPos[0].y, this.trebol.position.z + this.objPos[0].z);
		this.sceneObj.push(this.trebol);
		this.add(this.trebol);

		this.pica = new MyAce(this.gui, "");
		this.pica.position.set(this.pica.position.x + this.objPos[1].x,
			this.pica.position.y + this.objPos[1].y, this.pica.position.z + this.objPos[1].z);
		this.sceneObj.push(this.pica);
		this.add(this.pica);

		this.corazon = new MyHeart(this.gui, "");
		this.corazon.position.set(this.corazon.position.x + this.objPos[2].x,
			this.corazon.position.y + this.objPos[2].y, this.corazon.position.z + this.objPos[2].z);
		this.sceneObj.push(this.corazon);
		this.add(this.corazon);

		this.rombo = new MyRombo(this.gui, "");
		this.rombo.position.set(this.rombo.position.x + this.objPos[3].x,
			this.rombo.position.y + this.objPos[3].y, this.rombo.position.z + this.objPos[3].z);
		this.sceneObj.push(this.rombo);
		this.add(this.rombo);

		this.barrido = new MyBarrido(this.gui, "");
		this.barrido.position.set(this.barrido.position.x + this.objPos[3].x,
			this.barrido.position.y + this.objPos[3].y, this.barrido.position.z + this.objPos[3].z);
